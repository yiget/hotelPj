...
<!-- saved from url=(0041)http://www.yododo.cn/my/myHotelOrders.ydd -->
<html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  
  <title>我的订单-个人中心 | 多多驿站 - 旅游住宿订房首选品牌
      </title>
  <meta http-equiv="imagetoolbar" content="no">
  <meta name="robots" content="all">
    <meta name="keywords" content="">
    <meta name="description" content="">
    <meta name="mobile-agent" content="format=html5;url=http://m.yododo.cn/my/orders/">
  <style type="text/css">
    /* 20140108 font ico */
...
<script type="text/javascript">
  //<![CDATA[
  function checkDistrSearchOrder(){
    var mobile = $j("#mobile").attr("value");
    var orderid = $j("#orderid").attr("value");

    if(mobile == '' && orderid == ''){
      alert("请填写手机号或订单号进行查询！");
      return false;
    }
    return true;
  }
...
<div class="ht-main clearfix">
  ...
  <div class="ht-menu">
    ...
    <div class="ht-btitle jcmyodercont">
      <h3>我的订单</h3>
      <table width="100%" cellspacing="0" cellpadding="0" border="0" class="ddan tcenter">
            <tbody><tr>
              <th width="20%">订单号</th>
              <th width="20%">商品</th>
              <th width="15%">日期</th>
            ...
            <tr class="nline">
                    <td colspan="6" align="left"><strong>西双版纳新沙宾馆-阳台标准间</strong>
                    </td>
                    <td style="text-align: left;">
                      <a href="ordersSubmitted.jsp"><input type="button" value="支 付" title="支 付" class="ndp-sbtn08" ></a><!-- onclick="location.href=&#39;/sale/payHotelOrder.ydd?orderid=201812041000365&#39;;" -->
                          </td>
                  </tr>
                  <tr class="nline">
                    <td><a href="javascript:;" onclick="location.href=&#39;/my/orderDetail.ydd?orderid=201812041000365&#39;;">201812041000365</a></td>
                    <td>西双版纳新沙宾馆-阳台标准间</td>
                    <td>
                      2018-12-05<br>
                          2018-12-06</td>
                    <td>¥82.00</td>
                    <td><span class="red">未支付</span>
                        </td>
                    <td>1</td>
                    <td style="line-height:25px" align="left">
                      <a class="fcblue" href="javascript:;" onclick="if(isDel(&#39;确定要取消预订？&#39;)) location.href=&#39;/my/queryDeleteOrder.ydd?orderid=201812041000365&#39;;return false;">取消</a> |
                      <a href="orderDetails.jsp" class="fcblue" ><!--onclick="location.href=&#39;/my/orderDetail.ydd?orderid=201812041000365&#39;;return false;"  -->详细</a>
                        </td>
                  </tr>
...
function showRefundConfirmDialog(payType, orderid){
  ...
  function showRefundResultDialog(){
    var winheight = $j(window).height(),winwidth = $j(window).width(),blockTop,blockHeight;
    blockHeight = (winheight < 144 ? (winheight - Math.floor(winheight/10)) : 144);
    wintop = (winheight - blockHeight) /2;
    winleft = (winwidth - 502)/2 ;
    $j.blockUI({message:$j("#refund_result"),css:{top: wintop + "px", left: winleft + 'px', '_height':blockHeight + 'px',height: '0' + 'px', width:'0', cursor: 'default', border:'none'},overlayCSS:{cursor: 'default'}});
  }
